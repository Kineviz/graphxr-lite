...
> Note: The ./parquet_data directory stores the converted Parquet files.
> The repo already contains converted Parquet files for convenience.
...
source .demo_venv/Scripts/activate
...
> Note: Will automatically import data from the converted Parquet files when starting the services.
...
## Modeling the Graph
1. Log into the PuppyGraph Web UI at http://localhost:9081 with the following credentials:
